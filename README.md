...
`👩‍💻 한양대학교 컴퓨터학부`  - 재학중(4학년)      
ComputerScience Undergraduate at Hanyang University ERICA (2020.03 -  )
...
`🥜 산학 캡스톤 디자인 프로젝트`  - 졸업프로젝트      
5인 개발: Edge Computing을 통한 콘크리트 온습도 수집 및 건설현장 안전관리 플랫폼 개발      
Google Cloud, PostgreSQL, Kafka     
Team 하냥땅콩 Project Manager and Software Developer (2023.08 - 2024.05, 10 months)   
     
### *2. Certification* 🏅

`⚙️ 정보처리기사 (예정)` `⛅️ 아마존클라우드 아키텍처 자격증 (예정)` `🐘 SQLD (예정)`    
     
### *3. How to reach me* 📫

- email: annkwon1123@gmail.com
- blog: [개발자 블로그](https://annkwon1123.tistory.com)
- blog: [AiFi 프로젝트 블로그](https://blog.naver.com/annkwon11234)
- [Launchpad](https://launchpad.net/~annkwon1123)
